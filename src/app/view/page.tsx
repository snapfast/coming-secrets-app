...
function ViewSecretContent() {
  ...
  if (showCelebration) {
    return (
      <div className="cs-page-layout cs-page-overlay">
        <div className="cs-page-content">
          <div className="cs-page-inner">
            <Header />

            <div className="cs-loading-container cs-content-z-index">
              <div className="cs-content-center">
  ...
  if (!isUnlocked) {
    return (
      <div className="cs-page-layout cs-page-overlay">
        ...
        <div className="cs-decorative-element-1"></div>
        <div
          className="cs-decorative-element-2 cs-animation-delay-1s"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="cs-decorative-element-3 cs-animation-delay-2s"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="cs-decorative-element-4 cs-animation-delay-3s"
          style={{ animationDelay: "3s" }}
        ></div>

        <div className="cs-page-content">
          <div className="cs-page-inner cs-content-z-index">
            <Header />
          ...
          <div className="cs-loading-container-pb">
            <div className="cs-card-overlay cs-secret-card-locked">
              {/* Decorative background elements */}
              <div className="cs-card-decorative-purple"></div>
              <div className="cs-card-decorative-pink"></div>

              <div className="cs-content-z-index">
                {/* Sender Info */}
                  ...
                  <div className="cs-unlocked-sender">
                    ...
                    {timeRemaining.days === 0 && timeRemaining.hours < 24 && (
                      <div className="cs-countdown-alternative">
                        <p className="cs-body-small cs-countdown-alternative-label">
                          Alternative view:
                        </p>
                        <div className="cs-body-large cs-countdown-digital">
                ...
                {secretData.hint && (
                  <div className="cs-hint-container">
                    <p className="cs-body-small cs-hint-label">
                      Hint:
                    </p>
                    <p className="cs-body-small cs-hint-text">
                      {secretData.hint}
                    </p>
                  </div>
                )}

                <p className="cs-body-small cs-reminder-text">
                  Please check back when the countdown reaches zero!
                </p>

                {/* Smart Reminders */}
                <div className="cs-calendar-section">
                  <p className="cs-body-small cs-calendar-intro">
                    Get notified when this unlocks:
                  </p>

                  <div className="cs-flex-column cs-calendar-grid">
                    {/* Google Calendar */}
                    <button
                    ...
                    <button
                      ...
                      className="cs-calendar-button-gray"
                    >
      ...
      <div className="cs-page-content">
        <div className="cs-page-inner cs-content-z-index">
          ...
          <div className="cs-flex-center mb-4">
            <Link
              href="/"
              className="cs-button-primary cs-button-hover-scale"
            >
              Create New Message
            </Link>
          </div>

        <div className="cs-card-overlay cs-secret-card-unlocked">
          {/* Sender Info */}
          {secretData.senderName && (
            <div className="cs-unlocked-sender">
          ...
          {secretData.hint && (
            <div className="cs-unlocked-hint">
              <p className="cs-body-small cs-unlocked-hint-text">
